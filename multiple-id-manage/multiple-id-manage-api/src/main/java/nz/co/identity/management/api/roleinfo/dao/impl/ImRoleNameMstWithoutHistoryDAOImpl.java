 ...
 */
@Service(value = "stvIdmfRoleNameMstWithoutHistoryDAO")
public class ImRoleNameMstWithoutHistoryDAOImpl
    ...
    public ImRoleNameMst registerRoleName(ImRoleNameMst roleNameMst) {
        ...
        if (stvIdmfRoleNameMst != null) {
            ...
            if (stvIdmfRoleNameMstMapper.insert(roleNameMst) == 0) {
                throw new ImRuntimeException(
                        "Insert role name into DB with failed.");
            }
        }
    ...
    public ImRoleNameMst updateRoleName(ImRoleNameMst roleNameMst) {
        ...
        if (selectResult == null) {
            ...
            if (StringUtils.isEmpty(roleNameMst.getUpdatedUser())) {
                roleNameMst.setUpdatedUser(CommonUtils.getLoginUser());
            }

            roleNameMst.setVersionNo(inputVersionNo + 1);
            ...
            if (stvIdmfRoleNameMstMapper.updateByPrimaryKey(map) == 0) {
                throw new ImRuntimeException(
                        "Update role name into DB with failed.");
            }
        }
        return roleNameMst;
    }
    ...
    public boolean deleteRoleName(ImRoleNameMst roleNameMst) {
        ...
        if (StringUtils.isEmpty(locale)) {
            ...
            if (stvIdmfRoleNameMstMapper.deleteByRoleId(roleId) == 0) {
                throw new ImRuntimeException(
            ...
            if (stvIdmfRoleNameMstMapper.selectByRoleIdByLocale(roleId,
                    locale) == null) {
                throw new ImRecordInexistenceException(
            ...
            if (stvIdmfRoleNameMstMapper.deleteByRoleIdByLocale(roleId,
                    locale) == 0) {
                throw new ImRuntimeException(
                        "Delete role name from DB with failed.");
            }
    ...
    public boolean deleteForceRoleName(ImRoleNameMst roleNameMst) {
        if (stvIdmfRoleNameMstMapper
                .deleteByRoleId(roleNameMst.getRoleId()) == 0) {
            throw new ImRuntimeException(
                    "Delete role name from DB with failed.");
        }
