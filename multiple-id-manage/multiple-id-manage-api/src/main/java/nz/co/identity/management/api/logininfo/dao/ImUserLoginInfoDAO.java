 ...
 */
public interface ImUserLoginInfoDAO extends BaseDAO {
    ...
    /**
     * delete force the UserLoginInfo by login id and company code
     *
     * @param userLoginInfo
     *        userlogininfo entity
     * @return flag result(false, true)
     * @since Staveware Core Ver.5.3
     */
    boolean deleteForceUserLoginInfo(ImUserLoginInfo userLoginInfo);
    ...
    /**
     * search the userlogininfo by userlogininfo properties
     *
     * @param userLoginInfo
     *        userlogininfo entity
     * @param pageNum
