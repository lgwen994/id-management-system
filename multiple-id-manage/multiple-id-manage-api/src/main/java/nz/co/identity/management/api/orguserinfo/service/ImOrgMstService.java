...
/**
 * according to the organization form of CRUD operations, return a valid
 * data.<br>
 * organization's Service interface.<br>
 *
 * @since Staveware Core Ver.5.3
 */
public interface ImOrgMstService {
    ...
    /**
     * paging search the organization by organization properties
     *
     * @param orgMst
     *        organization entity
     * @param pageNum
