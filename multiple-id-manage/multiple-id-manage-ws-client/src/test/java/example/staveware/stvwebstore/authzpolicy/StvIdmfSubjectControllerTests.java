...
public class StvIdmfSubjectControllerTests
        extends StvSimpleAppApplicationTests {

    public static final String PATH_URL = "subject";
    ...
    private void registInputcheck() {
        ...
        driver.findElement(By
                .xpath("//*[@id='main']/section/main/div/div[2]/div/div[1]/div[2]/div/button[1]/span"))
                .click();
        sleep(DEFAULT_WAIT_TIME_2000L);
        // 必須が空文字
        Assert.assertEquals("IDMFサブジェクト登録", getHeaderTitle());
        driver.findElement(By.id("subjectCode")).click();
        ...
        // 入力エラー（大きすぎる）時
        driver.findElement(By.id("subjectCode")).click();
        driver.findElement(By.id("subjectCode")).sendKeys(
                "012345678901234567890123456789012345678901234567890123456789");
        driver.findElement(By.id("registSubject")).click();
        pressButton("OK");
        Assert.assertEquals("エラーが発生しました。\ninput check validation error",
                getAlertMessage());
        screenshoot(PATH_URL,
    ...
    private void registClear() {
        ...
        driver.findElement(By.id("subjectCode")).click();
        driver.findElement(By.id("subjectCode")).clear();
        driver.findElement(By.id("subjectCode")).sendKeys("subject");
        driver.findElement(By.id("valueType")).click();
        ...
        screenshoot(PATH_URL,
                Thread.currentThread().getStackTrace()[1].getMethodName(), null,
                2);
        Assert.assertEquals("", getInputTextValue("subjectCode"));
    ...
    private void registCancel() {
        ...
        screenshoot(PATH_URL,
                Thread.currentThread().getStackTrace()[1].getMethodName(), null,
                2);
        Assert.assertEquals("subject", getInputTextValue("subjectCode"));
    ...
    private void search() {
        ...
        screenshoot(PATH_URL,
                ...
                null);
        driver.findElement(By
                .xpath("//*[@id='main']/section/main/div/div[2]/div/div[2]/div[1]/div[2]/table/thead/tr/th[1]/div/label/span"))
                .click();
        screenshoot(PATH_URL,
                Thread.currentThread().getStackTrace()[1].getMethodName(), null,
                2);
    ...
    private void updateInputcheck() {
        ...
        screenshoot(PATH_URL,
                Thread.currentThread().getStackTrace()[1].getMethodName(), null,
                null);
        driver.findElement(By.id("updateSubject")).click();
        screenshoot(PATH_URL,
                Thread.currentThread().getStackTrace()[1].getMethodName(), null,
                2);
        pressButton("OK");
    ...
    private void updateSuccess() {
        ...
        screenshoot(PATH_URL,
                Thread.currentThread().getStackTrace()[1].getMethodName(), null,
                null);
        driver.findElement(By.id("updateSubject")).click();// 更新button
        screenshoot(PATH_URL,
                Thread.currentThread().getStackTrace()[1].getMethodName(), null,
                2);
        pressButton("OK");
    ...
    private void deleteCancel() {
        ...
        screenshoot(PATH_URL,
                ...
                2);
        driver.findElement(By
                .xpath("//*[@id='main']/section/main/div/div[2]/div/div[1]/div[2]/div/button[2]/span"))
                .click();
        screenshoot(PATH_URL,
                Thread.currentThread().getStackTrace()[1].getMethodName(), null,
                3);
