...
public class StvIdmfTitleMstControllerTests
        extends StvSimpleAppApplicationTests {

    public static final String PATH_URL = "title";
    ...
    private void registInputcheck() {
        ...
        // 入力エラー（大きすぎる）時 「項目：役職コード」
        driver.findElement(By.id("titleCode")).click();
        driver.findElement(By.id("titleCode")).clear();
        driver.findElement(By.id("titleCode")).sendKeys(
        ...
        // 入力エラー（大きすぎる）時 「項目：役職種別」
        driver.findElement(By.id("titleName")).click();
        driver.findElement(By.id("titleName")).clear();
        driver.findElement(By.id("titleType")).click();
        driver.findElement(By.id("titleType")).sendKeys(
                "012345678901234567890123456789012345678901234567891");
        screenshoot(PATH_URL,
    ...
    private void registClear() {
        ...
        Assert.assertEquals("", getInputTextValue("titleCode"));
        Assert.assertEquals("", getInputTextValue("company"));
        Assert.assertEquals("", getInputTextValue("titleName"));
        Assert.assertEquals("", getInputTextValue("titleType"));
    ...
    private void registCancel() {
        ...
        Assert.assertEquals("test1", getInputTextValue("titleCode"));
        Assert.assertEquals("Toshiba:東芝デジタルソリューションズ株式会社(-)",
                getInputTextValue("company"));
        Assert.assertEquals("テスト①", getInputTextValue("titleName"));
        Assert.assertEquals("役職種類１", getInputTextValue("titleType"));
    }
    ...
    private void search0record() {
        ...
        driver.findElement(By.id("titleCode")).click();
        driver.findElement(By.id("titleCode")).sendKeys("x");
    ...
    private void updateInputcheck() {
        ...
        screenshoot(PATH_URL,
                Thread.currentThread().getStackTrace()[1].getMethodName(), 1,
                1);
        driver.findElement(By.id("updateTitle")).click();
        screenshoot(PATH_URL,
                Thread.currentThread().getStackTrace()[1].getMethodName(), 1,
                2);
        pressButton("OK");
    ...
    private void updateCancel() {
        ...
        // グループフラグ設定
        driver.findElement(By
                .xpath("//span[@class='el-radio__label' and contains(text(), '実在役職')]"))
                .click();
        ...
        driver.findElement(By.id("titleType")).click();
        driver.findElement(By.id("titleType")).clear();
        driver.findElement(By.id("titleType")).sendKeys("役職種類２");
