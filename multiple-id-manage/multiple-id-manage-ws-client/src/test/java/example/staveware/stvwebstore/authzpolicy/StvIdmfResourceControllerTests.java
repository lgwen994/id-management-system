...
public class StvIdmfResourceControllerTests
        extends StvSimpleAppApplicationTests {

    public static final String PATH_URL = "resource";
    ...
    private void registInputcheck() {
        ...
        driver.findElement(By
                .xpath("//*[@id='main']/section/main/div/div[2]/div/div[3]/div[2]/div/button[1]/span"))
                .click();
        sleep(DEFAULT_WAIT_TIME_2000L);
        // 必須が空文字
        Assert.assertEquals("IDMFリソース登録", getHeaderTitle());
        driver.findElement(By.id("resourceCode")).click();
        driver.findElement(By.id("resourceCode")).clear();
        ...
        // 入力エラー（大きすぎる）時
        driver.findElement(By.id("resourceCode")).click();
        driver.findElement(By.id("resourceCode")).sendKeys(
                "012345678901234567890123456789012345678901234567890123456789");
        driver.findElement(By.id("registResource")).click();
        pressButton("OK");
        Assert.assertEquals("エラーが発生しました。\ninput check validation error",
                getAlertMessage());
        screenshoot(PATH_URL,
    ...
    private void registClear() {
        ...
        driver.findElement(By.id("resourceCode")).click();
        driver.findElement(By.id("resourceCode")).clear();
        driver.findElement(By.id("resourceCode")).sendKeys("resource");
        driver.findElement(By.id("valueType")).click();
        ...
        screenshoot(PATH_URL,
                Thread.currentThread().getStackTrace()[1].getMethodName(), null,
                2);
        Assert.assertEquals("", getInputTextValue("resourceCode"));
    ...
    private void registCancel() {
        ...
        screenshoot(PATH_URL,
                Thread.currentThread().getStackTrace()[1].getMethodName(), null,
                2);
        Assert.assertEquals("resource", getInputTextValue("resourceCode"));
    ...
    private void search() {
        ...
        screenshoot(PATH_URL,
                ...
                null);
        driver.findElement(By
                .xpath("//*[@id='main']/section/main/div/div[2]/div/div[4]/div[1]/div[2]/table/thead/tr/th[1]/div/label/span/span"))
                .click();
        screenshoot(PATH_URL,
                Thread.currentThread().getStackTrace()[1].getMethodName(), null,
                2);
        Assert.assertEquals("resource",
                driver.findElement(By
                        .xpath("//div[@id='main']/section/main/div/div[2]/div/div[4]/div[1]/div[3]/table/tbody/tr/td[2]/div"))
                        .getText());
    }
    ...
    private void update() {
        ...
        Actions action = new Actions(driver);
        WebElement element = driver.findElement(By.xpath(
                "//div[@id='main']/section/main/div/div[2]/div/div[4]/div[1]/div[3]/table/tbody/tr/td[2]/div"));
        action.doubleClick(element).perform();
        updateInputcheck();
        updateReset();
        updateCancel();
    ...
    private void updateInputcheck() {
        ...
        screenshoot(PATH_URL,
                Thread.currentThread().getStackTrace()[1].getMethodName(), null,
                null);
        driver.findElement(By.id("updateResource")).click();
        screenshoot(PATH_URL,
                Thread.currentThread().getStackTrace()[1].getMethodName(), null,
                2);
        pressButton("OK");
    ...
    private void updateSuccess() {
        ...
        screenshoot(PATH_URL,
                Thread.currentThread().getStackTrace()[1].getMethodName(), null,
                null);
        driver.findElement(By.id("updateResource")).click();// 更新button
        screenshoot(PATH_URL,
                Thread.currentThread().getStackTrace()[1].getMethodName(), null,
                2);
        pressButton("OK");
    ...
    private void deleteCancel() {
        ...
        screenshoot(PATH_URL,
                ...
                2);
        driver.findElement(By
                .xpath("//*[@id='main']/section/main/div/div[2]/div/div[3]/div[2]/div/button[2]/span"))
                .click();
        screenshoot(PATH_URL,
                Thread.currentThread().getStackTrace()[1].getMethodName(), null,
                3);
